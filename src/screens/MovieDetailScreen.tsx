...
const useMovieCastDetails = (movieid: number) => {
  return useQuery({
    queryKey: ['movieCastDetails', movieid],
    queryFn: () => fetchMovieCastDetails(movieid),
  });
};
...
const MovieDetailsScreen = ({navigation, route}: any) => {
  ...
  } = useMovieDetails(route.params.movieid);
  const {
    data: movieCastData,
    isLoading: isCastLoading,
    isError: isCastError,
  } = useMovieCastDetails(route.params.movieid);
  if (isMovieLoading || isCastLoading || isMovieError || isCastError) {
    return (
      <ScrollView
